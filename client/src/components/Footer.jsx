...
const Footer = () => {
  ...
  return (
    <div className='container px-4 2xl:px-20 mx-auto flex items-center gap-4 py-4 mt-20 justify-between border-y-2 '>
        ...
        <p className={`flex-1 border-1 ${isDarkMode ? 'text-white' : 'border-gray-400  text-gray-500'} pl-4 text-sm max-sm:hidden`}>Copyright @Listya Dwi Subagya | All Right Reserved.</p>
